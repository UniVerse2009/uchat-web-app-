...
module.exports = function initSocket(server, sessionMiddleware) {
	...
	io.on('connection', (socket) => {
		...
		// harap ubah lagi ke socket.on
		// Untuk test, gunakan io.on

		/* =========================
		   TYPING INDICATOR
		========================= */
		socket.on('chat:typing', ({ chatId, content }) => {
